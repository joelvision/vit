...
if __name__ == "__main__":
    ...
    parser.add_argument('--epochs', default=500, type=int, help='training epoch')
    ...
    # Image Patches
    d = patch.Flattened2Dpatches(dataname=args.dataname, img_size=args.img_size, patch_size=args.patch_size,
    ...
    if args.mode == 'train':
        ...
        for epoch in range(args.epochs):
            ...
            val_acc, val_loss = metric.accuracy(valloader, vit)
            # if epoch % 5 == 0:
        ...
        test_acc, test_loss = metric.accuracy(testloader, vit)
